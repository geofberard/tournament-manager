...
import com.gberard.tournament.adapter.service.SpreadsheetCRUDService;
...
class PlayerRepositoryTest {
    ...
    class Create {
        ...
        void shoud_use_crud_service() {
            ...
            verify(spreadsheetCRUDService, times(1))
                    .appendCells(eq(PlayerRepository.RANGE), eq(List.of(RAW_PLAYER_A)));
        }
    ...
    class ReadAll {
        ...
        void shoud_use_crud_service() {
            ...
            // Then
            verify(spreadsheetCRUDService, times(1)).readCells(eq(PlayerRepository.RANGE));
        }

        @Test
        void shoud_use_fromRawData_mapper() {
            // Given
            when(spreadsheetCRUDService.readCells(eq(PlayerRepository.RANGE))).thenReturn(List.of(RAW_PLAYER_A, RAW_PLAYER_B));
