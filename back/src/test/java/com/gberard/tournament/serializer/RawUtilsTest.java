...
class RawUtilsTest {
    ...
    class GetValue {
        ...
        void should_return_the_toString_method_of_targeted_element() {
            ...
            // When
            Optional<String> foundValue = getValue(rawData, 2, Function.identity());
        ...
        void should_return_the_result_of_mapper_with_value() {
            ...
            // When
            Optional<String> foundValue = getValue(of("1", "2", "3"), 2, mockFunction);
        ...
        void should_return_an_empty_string_if_target_is_empty() {
            // When
            Optional<String> foundValue = getValue(of("1", "2", ""), 2, Function.identity());
        ...
        void should_return_an_empty_string_if_target_dont_exist() {
            // When
            Optional<String> foundValue = getValue(of("1", "2", "3"), 3, Function.identity());
    ...
    class GetStringValue {
        ...
        void should_return_value() {
            // When
            Optional<String> foundValue = getStringValue(of("1", "2", "3"), 2);
    ...
    class GetBooleanValue {
        ...
        void should_return_empty_when_format_is_ok() {
            ...
            // Then
            assertThat(getBooleanValue(values, 1)).isPresent().hasValue(true);
            assertThat(getBooleanValue(values, 2)).isPresent().hasValue(false);
        }
        ...
        void should_return_false_when_format_is_ko() {
            ...
            // Then
            assertThat(getBooleanValue(values, 1)).isPresent().hasValue(false);
        }
    ...
    class GetIntValue {
        ...
        public void should_manage_empry_string() {
            ...
            // Then
            assertThat(getIntValue(values, 0)).isNotPresent();
        }
        ...
        public void should_manage_integer_in_string() {
            ...
            // Then
            assertThat(getIntValue(values, 1)).isPresent().hasValue(23);
        }
    ...
    class GetEnumValue {
        ...
        void should_return_element_based_on_name() {
            ...
            // Then
            assertThat(getEnumValue(values, 1, TestEnum.class)).isPresent().hasValue(TestEnum.VALUE2);
        }
        ...
        void should_return_empty_on_wrong_element() {
            ...
            // Then
            assertThat(getEnumValue(values, 1, TestEnum.class)).isNotPresent();
        }
    ...
    class GetDateTimeValue {
        ...
        void should_return_value_when_date_and_time_are_specified() {
            ...
            // Then
            assertThat(getDateTimeValue(values, 0, 1)).isPresent()
        ...
        void should_return_empty_on_date_unspecified() {
            ...
            // Then
            assertThat(getDateTimeValue(values, 0, 1)).isNotPresent();
        }
