...
import static com.gberard.tournament.service.SpreadsheetCRUDService.SEARCH_CELL;
...
class SpreadsheetCRUDServiceTest {
    ...
    protected static final String API_SHEETS_SEARCH_RANGE = API_SHEETS_VALUES + "/" + SHEET_NAME + "!" + SEARCH_CELL;
